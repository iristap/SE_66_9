...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2024 at 03:29 PM
...
-- Database: `se_g9`
--
CREATE DATABASE IF NOT EXISTS `se_g9` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `se_g9`;
...
--
ALTER TABLE `borrowing_list`
  MODIFY `borrowing_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
