...
(47, '2024-03-28', '2024-04-11', '2024-03-29', NULL, NULL, '2024-01-28', 1, 1, 1, 'พิจารณาแล้ว'),
(48, '2024-03-28', '2024-04-11', '2024-03-29', NULL, NULL, '2024-02-28', 1, 1, 1, 'พิจารณาแล้ว'),
(49, '2024-03-28', '2024-04-11', '2024-03-29', NULL, NULL, '2024-03-28', 1, 1, 1, 'พิจารณาแล้ว'),
(50, '2024-03-28', '2024-04-11', '2024-03-29', NULL, NULL, '2024-03-28', 1, 1, 1, 'พิจารณาแล้ว'),
(51, '2024-03-29', '2024-04-12', '2024-03-29', NULL, NULL, '2024-03-29', 1, 1, 1, 'พิจารณาแล้ว'),
(52, '2024-03-29', '2024-04-12', '2024-03-29', NULL, NULL, '2024-03-29', 1, 1, 2, 'พิจารณาแล้ว'),
(53, '2024-03-29', '2024-04-12', '2024-03-29', NULL, NULL, '2024-03-29', 4, 2, 2, 'พิจารณาแล้ว');
...
(81, 51, 12, 'อนุมัติแล้ว', NULL, 'นำไปถ่ายภาพแบบสินค้า', 'ได้ทำการคืนแล้ว'),
(82, 52, 11, 'อนุมัติแล้ว', NULL, 'ใช้พรีเซนต์งาน', 'ได้ทำการคืนแล้ว'),
(83, 53, 1, 'อนุมัติแล้ว', NULL, 'TEST', 'ได้ทำการคืนแล้ว'),
(84, 53, 2, 'ไม่อนุมัติ', 'เหตุผลไม่เพียงพอ', 'test2', 'ได้ทำการคืนแล้ว');
...
(8, 1, 1, '2024-03-29', '2024-03-29', 'นำไปใช้ในการทำงาน', NULL, 'อนุมัติแล้ว'),
(9, 4, 2, '2024-03-29', '2024-03-29', 'นำไปใช้วนการทำงาน', NULL, 'อนุมัติแล้ว');
...
(12, 'DA012', 'Canon กล้องถ่ายภาพ', 'ไม่พร้อมใช้งาน', 'ชำรุด');
...
(1, 'กระดาษ', 48, 'รีม'),
(2, 'ดินสอ', 75, 'แท่ง'),
(3, 'คลิปหนีบกระดาษ', 115, 'อัน'),
(4, 'น้ำยาลบคำผิด', 35, 'ชิ้น'),
(5, 'กาวแท่ง', 36, 'แท่ง'),
(6, 'กาวน้ำ', 60, 'อัน'),
(7, 'เทปแลคซีน', 78, 'ม้วน'),
(8, 'ลวดเย็บกระดาษ', 91, 'แพ็ค'),
(9, 'ยางลบ', 11, 'แพ็ค'),
(10, 'สมุดบันทึก', 80, 'เล่ม'),
(11, 'ปากกาน้ำเงิน', 20, 'แท่ง'),
(12, 'ปากกาเคมี', 45, 'แท่ง'),
(13, 'คัดเตอร์', 12, 'อัน'),
(14, 'ใบมีดคัดเตอร์', 19, 'ชิ้น'),
(15, 'ไม้บรรทัด', 79, 'อัน');
...
(21, 2, 'พัดลม 20 นิ้ว', 79, 'technician', 'ปกติ', 'ใบขาด'),
(22, 12, 'Canon กล้องถ่ายภาพ', 81, 'admin', 'ไม่สามารถซ่อมได้', 'เลนส์แตก'),
(23, 11, 'EXPOSE จอมอนิเตอร์ 32นิ้ว', 82, 'technician', 'ปกติ', 'หน้าไม่ติด'),
(24, 2, 'พัดลม 20 นิ้ว', 84, 'technician', 'ชำรุด', 'ใบขาด');
...
(4, 'Pa', 'Kr', 'test@gmail.com', NULL, '$2y$12$Hk5YJXFIwFn7GYgXK6k8jOSinixn9JMq7EVi0QLkmIgUk3LUftKL2', NULL, '2024-03-29 04:25:10', '2024-03-29 04:25:10');
...
--
ALTER TABLE `borrowing_list`
  MODIFY `borrowing_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT for table `disbursement`
--
ALTER TABLE `disbursement`
  MODIFY `disbursement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
