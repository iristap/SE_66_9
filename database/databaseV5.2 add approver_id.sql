...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2024 at 09:19 AM
...
(45, '2024-03-28', '2024-04-11', '2024-03-28', NULL, NULL, '2024-03-28', 1, 1, 1, 'พิจารณาแล้ว'),
(46, '2024-03-28', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'รอการพิจารณา');
...
(63, 45, 1, 'อนุมัติแล้ว', NULL, 'ก็จะใช้'),
(64, 45, 2, 'อนุมัติแล้ว', NULL, 'แงงง'),
(65, 46, 1, 'รอการอนุมัติ', NULL, 'อยากยืม');
...
(1, 'DA001', 'โต๊ะ 1 เมตร', 'ไม่พร้อมใช้งาน', 'ปกติ'),
(2, 'DA002', 'พัดลม 20 นิ้ว', 'พร้อมใช้งาน', 'ปกติ'),
(3, 'DA003', 'เก้าอี้สำนักงาน', 'พร้อมใช้งาน', 'ปกติ'),
(4, 'DA004', 'โน้ตบุ๊ก asus 01', 'พร้อมใช้งาน', 'ปกติ'),
...
(8, 1, 'โต๊ะ 1 เมตร', 'admin', 'ปกติ', 'ขาหัก'),
(12, 5, 'PC HP123', 'admin', 'ปกติ', 'เปิดไม่ติด'),
(14, 5, 'PC HP123', 'admin', 'ชำรุด', 'การ์ดจอพัง');
...
--
ALTER TABLE `borrowing`
  MODIFY `borrowing_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `borrowing_list`
--
ALTER TABLE `borrowing_list`
  MODIFY `borrowing_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
