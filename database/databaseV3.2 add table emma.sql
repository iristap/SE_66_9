...
(3, '2023-03-13', NULL, NULL, 'ใช้นอกสถานที่', NULL, NULL, 1, NULL, NULL, 'รอการอนุมัติ');
...
(2, 1, 2, '2024-03-14', '2024-03-15', 'ใช้งานเอกสาร', NULL, 'ไม่อนุมัติ');
...
--
ALTER TABLE `borrowing_list`
  MODIFY `borrowing_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `disbursement`
--
ALTER TABLE `disbursement`
  MODIFY `disbursement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
