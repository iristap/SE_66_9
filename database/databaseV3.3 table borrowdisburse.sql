...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2024 at 01:00 PM
...
(1, '2023-08-01', '2024-03-08', '2024-03-06', 'ใช้ในงานจัดโต๊ะทำบุญบริษัท', NULL, '2023-08-09', 2, 1, 3, 'ชำรุด'),
(2, '2023-12-20', '2024-03-27', '2024-03-22', 'อากาศร้อนมาก', 'เหตุผลไม่เพียงพอ', '2023-12-21', 2, 1, 3, 'ปกติ'),
(3, '2023-03-13', NULL, NULL, 'ใช้นอกสถานที่', 'ไม่รู้', '2024-03-15', 1, 2, NULL, 'ไม่อนุมัติ'),
(4, '2024-03-13', NULL, NULL, 'อยากเอาไปขาย', 'โดนไล่ออกนะคะ', '2024-03-15', 3, 2, NULL, 'ไม่อนุมัติ'),
(5, '2024-03-16', NULL, NULL, 'ยืมใช้แผนกบัญชี', NULL, NULL, 3, NULL, NULL, 'รอการอนุมัติ'),
(6, '2024-03-16', NULL, NULL, 'ยืมใช้ในแผนกบุคคล', NULL, NULL, 2, NULL, NULL, 'รอการอนุมัติ');
...
INSERT INTO `borrowing_list` (`borrowing_list_id`, `borrowing_id`, `durable_articles_id`) VALUES
(1, 3, 1),
(2, 3, 4),
(3, 2, 2),
(4, 1, 1),
...
(1, 1, NULL, '2024-03-14', NULL, 'ใช้ทำงานนอกสถานที่', NULL, 'รอการอนุมัติ'),
...
(1, 'DA001', 'โต๊ะ 1 เมตร', 'ว่าง', 'ปกติ'),
(2, 'DA002', 'พัดลม 20 นิ้ว', 'ไม่ว่าง', 'หาย'),
(3, 'DA003', 'เก้าอี้สำนักงาน', 'ถูกยืม', 'ชำรุด'),
(4, 'DA004', 'โน้ตบุ๊ก asus 01', 'ว่าง', 'ปกติ'),
(5, 'DA005', 'PC HP123', 'ว่าง', 'ปกติ');
