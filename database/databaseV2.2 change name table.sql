...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2024 at 04:42 PM
...
INSERT INTO `stocks_lists` (`id`, `id_stock`, `id_material`, `quantity`) VALUES
(4, 1, 1, 11),
(5, 1, 6, 22),
(6, 1, 2, 33),
(7, 1, 9, 44);
...
ALTER TABLE `stocks_lists`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_stock_2` (`id_stock`,`id_material`);
...
ALTER TABLE `stocks_lists`
  ...
  ADD CONSTRAINT `stocks_lists_ibfk_2` FOREIGN KEY (`id_material`) REFERENCES `material` (`material_id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
